            ...
            <div className="post-mahasiswa">
                        ...
                        <tbody>
                            {
                                this.state.listMahasiswa.map(mahasiswa => {
                                    return <Post key={mahasiswa.id} NIM={mahasiswa.id} nama={mahasiswa.nama} alamat={mahasiswa.alamat} hp={mahasiswa.hp} angkatan={mahasiswa.angkatan} status={mahasiswa.status} hapusMahasiswa={() => this.handleHapusMahasiswa(mahasiswa.id)} />
                                })
                            }
                        </tbody>
                    </table>
                </div>
                <h2 className="text-center my-5">Pendaftaran Mahasiswa</h2>
                <div className="form pb-2 border-bottom">
                    ...
                    <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                            <textarea className="form-control" placeholder="Masukkan Alamat..." id="alamat" name="alamat" cols="30" rows="3" onChange={this.handleTambahMahasiswa}></textarea>
                        </div>
                    </div>
                    <div className="form-group row">
